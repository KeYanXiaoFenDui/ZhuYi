...
insert  into `category`(`id`,`create_time`,`status`,`name`,`order`,`level`,`parent_id`,`type`,`nameEn`) values (1,NULL,1,'测试1',1,1,0,1,NULL),(2,NULL,1,'测试2',2,1,NULL,1,NULL),(3,NULL,1,'测试3',1,1,NULL,2,NULL),(4,NULL,1,'测试4',1,1,NULL,3,NULL);
...
CREATE TABLE `response_info` (
  ...
  `processStauts` int(4) DEFAULT NULL COMMENT '流程状态',
