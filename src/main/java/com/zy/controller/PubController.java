...
//        if(userId == -500){return CommonUtil.ToResultHashMap(status,"userId为空!",null);}
//        try {
//            iCollectService.deleteCollectByScenarioId(userId,scenarioId);
//            iUserStageTypeService.deleteUserStageTypeByScenarioId(userId,scenarioId);
...
//        if(scenarioId == -500){return CommonUtil.ToResultHashMap(status,"scenarioId为空!",null);}
//        try {
//            iCollectService.deleteCollectByStageTypeId(userId,scenarioId,userStageTypeId);
...
//        if(stageId == -500){return CommonUtil.ToResultHashMap(status,"stageId为空!",null);}
//        try {
//            iCollectService.deleteCollectByStageId(userId,scenarioId,userStageTypeId,stageId);
//        } catch (Exception e){
//            e.printStackTrace();
