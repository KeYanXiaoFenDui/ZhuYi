...
CREATE TABLE `collect` (
  ...
  `scenario_id` int(11) DEFAULT NULL COMMENT '所属剧本Id',
  `user_stage_type_id` int(11) DEFAULT NULL COMMENT '所属用户场景分类Id',
  `stage_id` int(11) DEFAULT NULL COMMENT '场景Id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='收藏表（建立用户场景分类与场景的关系）';
...
CREATE TABLE `scenario` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键Id',
  `title` varchar(100) DEFAULT NULL COMMENT '身份名称',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  `status` int(4) DEFAULT NULL COMMENT '状态(1有效,,,0无效)',
  `user_id` int(11) DEFAULT NULL COMMENT '所属用户Id',
  `scenario_name` varchar(100) DEFAULT NULL COMMENT '剧本名称',
  PRIMARY KEY (`id`)
...
INSERT INTO `user` VALUES ('2', '0', 'user0', '123456', '无效用户', '15212343254', 'wuxiao@aa.com', '2019-03-27 11:53:38', '2019-04-07 12:51:48', '0');
...
-- ----------------------------
-- Table structure for `user_stage_type`
-- ----------------------------
DROP TABLE IF EXISTS `user_stage_type`;
CREATE TABLE `user_stage_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键Id',
  `title` varchar(100) DEFAULT NULL COMMENT '身份名称',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  ...
  `user_id` int(11) DEFAULT NULL COMMENT '所属用户Id',
  `scenario_id` int(11) DEFAULT NULL COMMENT '所属剧本Id',
  `type_name` varchar(100) DEFAULT NULL COMMENT '场景分类名称',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='用户场景分类';

-- ----------------------------
-- Records of user_stage_type
-- ----------------------------
