...
public class CollectStageVo implements Serializable {
    private int id;//唯一标识
    ...
    public int getUserStageTypeId() {
        return userStageTypeId;
    }

    public void setUserStageTypeId(int userStageTypeId) {
        this.userStageTypeId = userStageTypeId;
    }
}
